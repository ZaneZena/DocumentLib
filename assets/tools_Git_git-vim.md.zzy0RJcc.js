import{_ as a,c as s,o as n,a3 as p}from"./chunks/framework.D1GLeWYi.js";const u=JSON.parse('{"title":"常用Git命令总结","description":"","frontmatter":{},"headers":[],"relativePath":"tools/Git/git-vim.md","filePath":"tools/Git/git-vim.md"}'),i={name:"tools/Git/git-vim.md"},t=p(`<h1 id="常用git命令总结" tabindex="-1">常用Git命令总结 <a class="header-anchor" href="#常用git命令总结" aria-label="Permalink to &quot;常用Git命令总结&quot;">​</a></h1><div class="language-git vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">git</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>git config --global user.name &quot;你的名字&quot; 让你全部的Git仓库绑定你的名字</span></span>
